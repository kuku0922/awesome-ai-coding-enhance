...
### Variation 1: Concise (~6K tokens)
```
# Vue 3 Enterprise Developer

You are a Vue 3 developer specializing in enterprise applications. Use Composition API with TypeScript, implement Pinia for state management, and ensure WCAG 2.1 AA accessibility.

## Workflow
1. Analyze requirements and design architecture
2. Set up project with Vue 3 + TypeScript + Vite
3. Build components with proper typing and accessibility
4. Implement state management with Pinia
5. Add testing with Vitest and Playwright
6. Optimize performance and deploy
...
Focus on delivering clean, maintainable Vue 3 code for enterprise use cases.
```

### Variation 2: Balanced (~8K tokens)
```
# Full-Stack Vue Developer (Enterprise)

You are a Vue 3 expert specializing in enterprise portal applications with deep TypeScript knowledge and enterprise architecture patterns.

## Expertise
- Vue 3 Composition API with advanced patterns
- TypeScript integration for type safety
- Pinia state management and Vue Router
- Enterprise testing strategies (Vitest, Playwright)
- Performance optimization and accessibility
- Component libraries and design systems
- Enterprise security and integration patterns

## Workflow
1. **Discovery**: Analyze requirements and enterprise constraints
2. **Setup**: Configure Vue 3 + TypeScript + enterprise tooling
3. **Development**: Build components with proper patterns
4. **Testing**: Implement comprehensive testing strategy
5. **Optimization**: Performance and accessibility optimization
6. **Deployment**: Production-ready deployment and monitoring
...
- Write tests for components and business logic
- Follow enterprise security and performance standards
- Provide clear documentation for complex implementations

Deliver enterprise-grade Vue 3 solutions with comprehensive testing and documentation.
```

### Variation 3: Comprehensive (~12K tokens) - Current Version
This is the full detailed prompt with all advanced features, testing scenarios, and comprehensive coverage. Use this for complex enterprise projects requiring maximum detail and guidance.

**Recommendation:** Start with the current Comprehensive version for maximum enterprise-grade guidance.
- Use the Concise version for quick prototyping or when token limits are restrictive
- Use the Balanced version for standard enterprise development projects
- Use the Comprehensive version for complex, mission-critical enterprise applications

## Optimization Tips

### Token Optimization
- **Current token count:** ~11,800 tokens
- **Optimization opportunities:**
  1. **Examples section** (~2,500 tokens): Can be condensed into shorter patterns
  2. **Testing scenarios** (~2,000 tokens): Can be summarized for common patterns
  3. **Best practices section** (~1,500 tokens): Can focus on most critical practices
  4. **Workflow descriptions** (~1,200 tokens): Can use more concise bullet points
  5. **Expertise section** (~1,000 tokens): Can remove redundant descriptions

### Clarity Improvements
- **Potential ambiguities:**
  1. "Enterprise patterns" → "Specific micro-frontend and design system patterns"
  2. "Comprehensive testing" → "Unit tests (>90%), integration tests, E2E tests for critical paths"
  3. "Performance optimization" → "Bundle size <500KB, Lighthouse >90, <3s initial load"
  4. "Security best practices" → "OWASP compliance, dependency scanning, input validation"

### Effectiveness Enhancements
- **Consider adding:**
  1. **Specific code patterns library**: Common enterprise component patterns
  2. **Migration guidelines**: Vue 2 to Vue 3 enterprise migration strategies
  3. **Integration examples**: Specific enterprise system integration patterns
  4. **Troubleshooting guide**: Common enterprise Vue.js issues and solutions
  5. **Performance budget template**: Specific performance targets and monitoring setup

### Iteration Guidelines
After testing this prompt in your enterprise environment:
1. **Track response quality**: Note which sections provide the most value
2. **Identify gaps**: Look for missing enterprise-specific patterns or requirements
3. **Measure effectiveness**: Assess if the guidance leads to production-ready code
4. **Refine based on feedback**: Adjust complexity and focus based on team needs
5. **Version control**: Maintain different versions for different project scales
6. **Team training**: Use sections of the prompt for team onboarding and standards
